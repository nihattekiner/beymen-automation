...
public class ProductPage extends WebMainPage {
    ...
    public static final BaseElement CHOOSE_SIZE_SMALL = new BaseElement(By.xpath("(//span[contains(@class,'m-variation')])[1]"));
    public static final BaseElement CHOOSE_SIZE_MEDIUM = new BaseElement(By.xpath("(//span[contains(@class,'m-variation')])[2]"));
    public static final BaseElement CHOOSE_SIZE_LARGE = new BaseElement(By.xpath("(//span[contains(@class,'m-variation')])[3]"));
    public static final BaseElement CHOOSE_SIZE_XLARGE = new BaseElement(By.xpath("(//span[contains(@class,'m-variation')])[4]"));
