...
public class CartPage extends WebMainPage {
    ...
    public static final BaseElement QUANTITY = new BaseElement(By.xpath("//select[@class='a-selectControl -small']"));
    public static final BaseElement EMPTY_CART = new BaseElement(By.xpath("//strong[contains(text(),'Sepetinizde Ürün Bulunmamaktadır')]"));
